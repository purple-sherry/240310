...
세은이는 피해자인데 이 조사로 인해 더 큰 심리적 고통을 겪고 있는 것 같습니다. 사건 발생 당시에는 직접 연락하지 않았지만, 최근에 인사 처리 과정에서 얼마나 힘들었는지 이야기하며 많이 힘들어하는 모습을 보였습니다.
...
세은이 팀에서 다른 여사원도 유사한 사건을 겪었고, 가해자들이 선처받고 있다고 느꼈습니다. 만약 해당 팀에서 계속해서 이러한 문제가 발생한다면, 그건 인사팀의 안일한 대처 때문일 것입니다.
