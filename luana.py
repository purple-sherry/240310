...
name = "LUANA"
access = "ikO4cshJ95EiJEStBcm5eqYg9KC6fCqmK91Ygs2i"
secret = "fxthaZPt4EgomCMNUdxnof6YUZAMPx4yhxiNI9E6"

original_coin_list = ["ETH", "BCH", "ADA", "LINK", "GAS",
                      "STX", "THETA", "AXS", "WAXP", "EOS",
                      "HUNT", "ONT", "ONG", "STRAX", "SAND",
                      "ATOM", "ETC", "QTUM", "HIVE", "ICX",
                      "NEO", "DOGE", "BTG", "XRP", "BSV", "DOT"]

additional_coins = ["ETH", "LINK", "GAS", "ETC", "BCH"] #240228_추가
